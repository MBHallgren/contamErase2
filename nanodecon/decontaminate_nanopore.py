...
def nanopore_decontamination(arguments):
    ...
    all_validated_rmlst_mutations = co_occuring_mutations_in_reads(arguments, all_validated_rmlst_mutations, gene_score_dict, arguments.output + '/specie.fsa', allele_pair_dict)
