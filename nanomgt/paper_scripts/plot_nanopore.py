...
path = '/home/people/malhal/contamErase/data/nanopore/intra/paper/results/q12'
files = os.listdir(path)
original_input_path = '/home/people/malhal/contamErase/data/nanopore/intra/paper/subsets/'
for item in files:
    if item != 't.py':
        print (item)
